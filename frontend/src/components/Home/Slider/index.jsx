    ...
    return (
        <div className='flex relative'>
            ...
            <div className='absolute w-full h-full flex justify-between'>
                <button className='px-3 bg-[rgba(17,24,39,0.3)] transition-all ease-linear hover:bg-[rgba(17,24,39,0.5)]' onClick={() => isSlide>0 ? setIsSlide(isSlide-1) : setIsSlide(img_list.length-1)}>{`<`}</button>
